...
export const movies: Movie[] = [
  ...
  },
  {
    ...
    title: "Pulp Fiction",
    description:
      "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption. Through its unique storytelling, the film redefines the genre with its non-linear narrative and unforgettable characters.",
    releaseDate: "14-10-1994",
    genre: ["Crime", "Drama"],
    rating: 8.9,
